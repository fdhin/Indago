...
| WU007 | `WUEnvironmentAudit` | WindowsUpdate | System | WU agent version, OS edition/build/UBR with feature update eligibility table (Win10 2004-22H2, Win11 21H2-26H1), .NET Framework version decode, PowerShell version, third-party AV detection with 10-vendor WU-interference flagging, update management tool inventory (SCCM/Intune/PatchMyPC/WSUS/ManageEngine/Automox) with co-management detection, and Visual C++ prerequisite check |
