...
namespace RunAsUser
{
    ...
    internal class NativeMethods
    {
        ...
        // Fixed Bug #4: SafeHandle overload for actual data retrieval
        [DllImport("advapi32.dll", SetLastError = true)]
        ...
        // Fixed Bug #4: IntPtr overload for buffer-size query (avoids SafeHandle invalid-zero crash)
    ...
    public static class ProcessExtensions
    {
        ...
        // Fixed Bug #4: use IntPtr.Zero directly for buffer-size probe instead of
